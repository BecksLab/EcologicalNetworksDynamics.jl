...
test_files = [
    ...
    "test-utils.jl",
    joinpath("inputs", "test-foodwebs.jl"),
    joinpath("inputs", "test-biological_rates.jl"),
    joinpath("inputs", "test-functional_response.jl"),
    joinpath("inputs", "test-environment.jl"),
    joinpath("inputs", "test-nontrophic_interactions.jl"),
    joinpath("inputs", "test-producer_competition.jl"),
    joinpath("model", "test-productivity.jl"),
    joinpath("model", "test-metabolic_loss.jl"),
    joinpath("model", "test-effect_nti.jl"),
    joinpath("model", "test-model_parameters.jl"),
    joinpath("model", "test-consumption.jl"),
    joinpath("model", "test-simulate.jl"),
    joinpath("measures", "test-functioning.jl"),
    joinpath("measures", "test-structure.jl"),
    joinpath("measures", "test-utils.jl"),
]
